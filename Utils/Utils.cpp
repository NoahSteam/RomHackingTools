...
void FindAllDirectoriesWithinDirectory(const string& inDirectoryPath, vector<string>& outDirectories) {
  try {
    ...
    // Non-recursive — only the immediate children of inDirectoryPath
...
const std::string &InImageDirectory, const std::string& InOutputPhpFilePath)
{
	TextFileWriter htmlFile;
	const string htmlFileName = InImageDirectory + InOutputPhpFilePath;
	...
	for (const FileNameContainer& fileName : imageFiles)
	{
		...
		fprintf(htmlFile.GetFileHandle(), "					<td align=\"center\" width=\"20\">%s</td><td width=\"128\" height=\"16\" align=\"center\"><img src=\"..\\ExtractedData\\SakuraWars2\\Disc1\\%s\\%s.png\" ></td><td width=\"480\"><textarea id=\"edit_%i\" contenteditable=true onchange=\"SaveEdits('%i.bmp', 'edit_%i')\" style=\"border: none; width: 100%%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\">Untranslated</textarea></td>\n", pImageNumber, InImagePathOnServer.c_str(), pImageNumber, i, i, i);
