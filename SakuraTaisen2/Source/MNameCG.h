...
bool CreateNameCG1Spreadsheet(const string& imageDirectory)
{
	...
	const string htmlFileName = imageDirectory + string("..\\..\\Translation\\MNameCG2.php");
	...
	htmlFile.WriteString("	<div id=\"FileName\" style=\"display: none;\">MNameCG2</div>\n");
	...
	htmlFile.WriteString("	{\n");
	htmlFile.WriteString("		if( $value == \"MNameCG2\" )\n");
	htmlFile.WriteString("		{\n");
	...
	htmlFile.WriteString("		<article><header align=\"center\"><h1>File: MNameCG2</h1></header></article>\n");
